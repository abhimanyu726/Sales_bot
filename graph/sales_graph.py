...
from nodes.qualification_node import (
    QualificationNode
)
...
from nodes.adherence_node import (
    AdherenceNode
)

from nodes.crm_node import (
    CRMNode
)

from nodes.escalation_node import (
    EscalationNode
)
...
class SalesGraph:
    ...
    def build(self):
        ...
        self.workflow.add_node(
            "lead_qualification",
            qualification_node.execute
        )

        self.workflow.add_node(
            "response_generation",
            response_node.execute
        )

        self.workflow.add_node(
            "adherence_validation",
            adherence_node.execute
        )
